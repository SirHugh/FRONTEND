...
function ControlStock() {
  ...
  return (
    <>
      <ConfirmationModal
        show={showConfirm}
        title="Cerrar Control de Stock"
        onConfirm={handleCloseControl}
        onCancel={() => setShowConfirm(false)}
      >
        <div className="flex flex-col pt-3 gap-3 text-xl">
          <p>¿Está seguro que desea cerrar el Control de Stock?</p>
          <small className="text-red-700 font-semibold">
            Al confirmar, esto impactara en la cantidad de stock de los
            productos contados.
          </small>
        </div>
      </ConfirmationModal>
      <div className="flex justify-center py-5">
        <div className="flex flex-col w-4/5 border rounded-lg p-5 gap-3 justify-center">
          ...
          <div className="flex flex-col gap-3 text-xl">
            ...
            {controlStock.es_activo ? (
              <div className="flex flex-row justify-end gap-3">
                ...
                <Button color="dark" onClick={() => setShowConfirm(true)}>
                  Finalizar Control
                </Button>
              </div>
            ) : (
          ...
          <div>
            <big className="flex justify-center text-xl font-bold">
              Detalle{" "}
            </big>
            <Table
