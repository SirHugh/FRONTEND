    ...
    <div className="min-h-screen relative flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-md w-full">
        ...
        <div className="bg-white bg-opacity-100 px-8 py-6 rounded-md shadow-lg">
          <h1 className="text-2xl font-semibold mb-4 text-center">Introduzca sus credenciales</h1>
          <form onSubmit={loginUser} className="space-y-4">
            ...
            <div className="text-center">
              <button type="submit" className="bg-blue-500 text-white rounded-md px-4 py-2">Iniciar sesión</button>
            </div>
          </form>
        </div>
      </div>
